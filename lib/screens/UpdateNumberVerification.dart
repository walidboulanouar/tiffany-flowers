...
class UpdateNumberVerification extends StatefulWidget {
  ...
  @override
  _UpdateNumberVerificationState createState() =>
      _UpdateNumberVerificationState();
}

class _UpdateNumberVerificationState extends State<UpdateNumberVerification> {
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          hasError ? LocaleKeys.Pleasefillcells.tr() : "",
                          style: const TextStyle(
                              // color: Color(0xff73BFBD),
                              fontSize: 12,
                            ...
                            onPressed: () async {
                              if (formKey.currentState!.validate()) {
                                ...
                                if (response.statusCode == 200) {
                                  ...
                                  //     userProvider);
                                  updateUserPhone(userProvider.user!.phone,
                                      widget.phoneNumber!);
                                  sqlService.editUserPhone(
                                      widget.phoneNumber!, userProvider);
                                  Navigator.of(context, rootNavigator: true)
                                      ...
                                      : null;
                                  snackBar(
                                    LocaleKeys.PhoneUpdated.tr(),
                                  );

                                  accountScreen.currentState!
